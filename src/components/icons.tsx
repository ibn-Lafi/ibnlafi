...
export function TrophyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M12 11.5V15" />
      <path d="M9 20h6" />
      <path d="M10.3 20c0-2.2.8-3.5 1.7-3.5s1.7 1.3 1.7 3.5" />
    </svg>
  );
}
...
export function SparklesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 3.5 13.3 8 17.5 9 13.3 10 12 14.5 10.7 10 6.5 9 10.7 8 12 3.5Z" />
      <path d="M18.5 14 19 15.8 20.5 16.3 19 16.8 18.5 18.5 18 16.8 16.5 16.3 18 15.8 18.5 14Z" />
    </svg>
  );
}
...
export function GraduationCapIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M6.5 10.7v4c0 1.5 2.5 3 5.5 3s5.5-1.5 5.5-3v-4" />
      <path d="M21.5 8.7V14.2" />
    </svg>
  );
}
...
export function BookOpenIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 6.8c-1.6-1.1-3.9-1.6-6-1.6a1 1 0 0 0-1 1v11c0 .6.4 1 1 1 2.1 0 4.4.5 6 1.6 1.6-1.1 3.9-1.6 6-1.6.6 0 1-.4 1-1v-11c0-.6-.4-1-1-1-2.1 0-4.4.5-6 1.6Z" />
      <path d="M12 6.8v12.4" />
    </svg>
  );
}
