...
export const ar: PortfolioContent = {
  ...
  about: {
    title: "نبذة عني",
    paragraphs: [
      "متخصص في بناء وتطوير استراتيجية العلامات التجارية وإدارة وتطوير المنتجات والأعمال، أمتلك خبرة في تحويل الأفكار والأنشطة التقليدية إلى علامات تجارية قابلة للنمو، من خلال دراسة السوق واحتياجات العملاء، وتطوير المنتجات، وبناء الهوية والتموضع، وتحديد فرص النمو.",
  ...
  contact: {
    ...
    whatsappDisplay: "+966 55 077 2934",
