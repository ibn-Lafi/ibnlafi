...
export const ar: PortfolioContent = {
  ...
  hero: {
    ...
    tagline:
      "متخصص في بناء وتطوير العلامات التجارية وإدارة وتطوير المنتجات والأعمال. أحوّل الأفكار والأنشطة التقليدية إلى علامات تجارية قابلة للنمو من خلال دراسة السوق واحتياجات العملاء، وتطوير المنتجات، وبناء الهوية والتموضع، وتحديد فرص النمو.",
